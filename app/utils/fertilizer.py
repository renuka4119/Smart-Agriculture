fertilizer_dic = {
        ...
        <br/>7. <i> Create a solution which has been matured and soaked with banana peels then pour the solution to the soil .
        ...
        <br/>2. <i>Use cocopeat for soil padding </i> – if you can limit the amount of phosphorous added to your soil, you can let the plants use the existing phosphorus while still providing other key nutrients such as Nitrogen and Potassium. Add a concotion of liquid which is created with pottasium humate and a small amount of fulvate along with Jaggery and Chana dal added as microbe food .
        ...
        <br/>8. If soil pH is low, add moringa extract in minute quantity to the soil as fertilizers. Along with non-compost manure increasing the pH value of the soil.

        <br/>9. If pH is high, addition of appreciable amount of organic matter will help acidify the soil. Application of acidifying fertilizers, such as soybean powder , can help lower soil pH""",

        'KHigh': """The K value of your soil is high</b>.
        <br/> Please consider the following suggestions:

        <br/><br/>1. <i>Loosen the soil</i> deeply with a shovel, and water thoroughly to dissolve with banana peel soaked solution . Allow the soil to fully dry, and repeat digging and watering the soil two or three more times.
        ...
        <br/>3. Stop using commercial fertilizers all together and to begin using only organic matter to enrich the soil.
        ...
        <br/>5. Grow a cover crop of legumes that will fix nitrogen in the soil. This practice will meet the soil’s needs for nitrogen without increasing phosphorus or potassium.
        """,

        'Klow': """The K value of your soil is low.
        <br/>Please consider the following suggestions:

        <br/><br/>1. Mix in muricate of arjun chal extract, moringa extract, soy extract and maunre 
